                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Do I need an account to place an order?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body"> While you can browse the menus without an account, creating an account allows you to save your delivery addresses, view order history, and access exclusive offers. Signing up also makes checkout faster for future orders. </div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>How long does delivery usually take?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq2" aria-expanded="true" role="article">
                              <div class="panel-body"> Delivery times vary based on the restaurant's preparation time and your location. Once you place an order, you’ll receive an estimated delivery time, and you can track your order status in real-time. </div>
                           </div>
                        </div>
                        <!-- end:Panel -->
